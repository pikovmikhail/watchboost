	...
	class WC_Email_Customer_Completed_Order extends WC_Email {
		...
		public function trigger( $order_id, $order = false ) {
			...
			if ( $this->is_enabled() && $this->get_recipient() ) {
				$this->send( $this->get_recipient(), $this->get_current_subject($order_id), $this->get_content(), $this->get_headers(), $this->get_attachments() );
			}
		...
		public function get_current_subject($order_id) {
			return __( 'Your Order ID: #00'.$order_id.' from OverWatchBoostPro', 'woocommerce' );
		}
