...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="row">
		<header class="entry-header">
			<?php
			if ( is_singular() ) :
				the_title( '<h1 class="text-center bignoodleFont primary_orange_text entry-title">', '</h1>' );
			else :
		...
		<?php
			the_content( sprintf(
				wp_kses(
					...
					__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'boost' ),
					array(
						'span' => array(
							'class' => array(),
						),
